const Footer = () => {
  return (
    <footer className="bg-Very-Dark-Blue py-10 md:py-6">
      <div className="flex flex-col gap-8 max-w-desktop mx-auto w-11/12 items-center md:flex-row  justify-between">
