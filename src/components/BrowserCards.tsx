...
function Card({ Heading, version, icon, StyleClasses }: Readonly<CardProps>) {
  return (
    <div
  ...
  return (
    <div className="py-10 lg:py-16">
      <div className="">
        <div className="flex flex-col justify-center gap-5 max-w-[600px] mx-auto w-4/5 ">
          ...
          <p className="text-center max-w-[540px] leading-relaxed text-Grayish-Blue text-sm font-rubik md:text-lg mx-auto">
            Choose from our wide range of professional home repair services.
            Whether it's furniture fixing, electrical work, or kitchen
            maintenance, our experts are ready to help.
          </p>
        </div>
      </div>
      ...
      <div className="py-10 flex flex-col max-w-4xl w-11/12 mx-auto justify-between items-center lg:flex-row gap-12 lg:gap-8 ">
        <Card
          Heading={"Furniture Repair"}
          version={62}
          icon={"logo-chrome.svg"}
        />
        <Card
